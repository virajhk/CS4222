package com.cs4222.khuthia.lightanalyzer;
...
public class LightAnalyzerActivity
    ...
    public void onSensorChanged( SensorEvent event ) {
        ...
        updateLocationTextView( timestamp, location);
    }
    ...
    private void updateLocationTextView( long timestamp ,
                                      float location ) {
        ...
        final StringBuilder sb = new StringBuilder();
        sb.append( "\nLocation--" );
        sb.append( "\nCurrent location of user: " + locationName );
